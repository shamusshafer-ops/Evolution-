...
|44| Field Notebook and causal inspection | Persistent events, organism energy/life history, lineage follow, paired comparisons, and honest evidence language | M | **Two slices shipped 2026-08-02** — durable evidence log, real-organism inspector, scenario groups, one manual pair, and an isolated five-seed Plains–Oasis batch with variability/effect size/negative-result reporting; generalized experiments and full lineage follow remain |
